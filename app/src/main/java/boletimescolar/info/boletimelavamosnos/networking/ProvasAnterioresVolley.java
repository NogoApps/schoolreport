...
public class ProvasAnterioresVolley extends Request<JSONObject> {
    ...
    public ProvasAnterioresVolley(Context context, List<ProvaDomain> provaArray, int method, String url, Response.Listener<JSONObject> response, Response.ErrorListener listener) {
        super(method, url, listener);
        this.response = response;
        this.provaArray = provaArray;
        this.context = context;Log.d("TesteLog", "Chamado");
    }
